...
<img src="./images/arm.png" width=95% height=95%/> 
...
<img src="./images/rg_template.png" width=95% height=95%/>
...
<img src="./images/vnet_peering.png" width=95% height=95%/> 
...
<img src="./images/system_route.png" width=95% height=95%/> 
...
<img src="./images/dmz.png" width=95% height=95%/> 
...
<img src="./images/dmz_route.png" width=95% height=95%/> 
...
Now route traffic from dmz to private. So that public subnet can reach to private subnet via vmz.  
 ...
 <img src="./images/dmz_forwarding.png" width=95% height=95%/> 
...
<img src="./images/service_endpoint.png" width=95% height=95%/> 

Example: Access storage account from Vm within Vnet.  
1. Create Service account in Vnet.  

<img src="./images/service_endpoint_create.png" width=95% height=95%/> 
 

2. Allow access only from specific Vnet in Storage account.  

<img src="./images/storage_account_allow.png" width=95% height=95%/> 
...
<img src="./images/private_endpoint.png" width=95% height=95%/>
...
<img src="./images/vnet_peeringg.png" width=95% height=95%/>
